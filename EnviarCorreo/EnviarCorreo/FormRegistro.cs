    ...
    public partial class FormRegistro : Form
    {
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            if (txt_email1.TextLength != 0 || txt_email2.TextLength != 0 || txt_email3.TextLength != 0 || txt_email4.TextLength != 0 || txt_email5.TextLength != 0)
            {
                ...
                System.IO.StreamWriter file = new System.IO.StreamWriter("C:\\Users\\Alex\\Documents\\correos.txt");
                file.Write(lines);
                file.Close();
                MessageBox.Show("Verifique el archivo de correos en C:\\Users\\Alex\\Documents\\correos.txt" + " - Sus correos registrados son: " + lines);
            }else
            {
